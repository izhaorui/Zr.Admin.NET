...
namespace ZR.ServiceCore.Services
{
    ...
    public class SysUserService(
        ...
        ISysUserMsgService userMsgService) : BaseService<SysUser>, ISysUserService
    {
        ...
        public SysUser SelectUserById(long userId)
        {
            ...
            {
                user.Roles = sysRoleService.SelectUserRoleListByUserId(userId);
        ...
        {
            var roleIds = sysRoleService.SelectUserRoles(user.UserId);
